import type { Animate } from "./animate.ts";
import { palette as buildPalette, type Palette } from "./color.ts";
import type { Expression, Posable } from "./expression.ts";
import { superellipse } from "./shape.ts";
import { traits, type TraitOverrides, type Traits } from "./traits.ts";
